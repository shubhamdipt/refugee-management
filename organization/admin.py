...
@admin.register(OrganizationTransferRules)
class OrganizationTransferRulesAdmin(admin.ModelAdmin):
    list_display = ("id", "created", "modified", "headline", "organization")
    list_filter = ("organization", "modified")
